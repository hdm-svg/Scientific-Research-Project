...
HD_PWD='D:/Vivado/NCKH/asc/asc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log permutation_loop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source permutation_loop.tcl
