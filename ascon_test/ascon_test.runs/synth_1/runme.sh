...
HD_PWD='D:/Vivado/NCKH/ascon_test/ascon_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ascon_update.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ascon_update.tcl
