...
//`define msg 72'h616263646566676869 //984d4f549bdd112f5018ae97e074c69aab20385991f1c8c4f1c5eabf61a55646
//`define msg 56'h61626364656667 //45328cd16c567655ca9ed37afc53557016e09e574aa2e8a6f14982067a1d02e8
...
//    logic [319:0] msg;
    ...
    ascon_update #(.k(`k), .r(`r), .a(`a), .a_b(`a_b), .h(`h), .l(`l), .msg(`msg)) uut (
        .*
    );
